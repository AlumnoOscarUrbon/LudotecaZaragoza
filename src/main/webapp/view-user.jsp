    ...
    <div class="accordion" id="accordionUsers">
        <%
            ...
            if (actualUserRole.equals("admin")) {
                ...
                actualUserList = Database.jdbi.withExtension(UserDao.class, dao -> dao.getAllUsers(actualUserId));
            } else if (!actualUserId.equals("noId")) {
        ...
        <div class="accordion-item" id="accordion-item-<%=actualUser.getUserId()%>">
            <h2 class="accordion-header">
                <button class="accordion-button d-flex justify-content-between <%if (!isFirstTime){ %> collapsed <%}%>"
            ...
            <div id="collapse<%=actualUser.getUserId()%>" class="accordion-collapse collapse <%if (isFirstTime){ %> show <%}%>" data-bs-parent="#accordionUsers">
                ...
                <div id="result-user-<%=actualUser.getUserId()%>"></div>
            </div>
        </div>
        <%
                isFirstTime= false;
